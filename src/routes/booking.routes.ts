...
import type { BookingDoc } from "../types/models.js";
...
router.post(
  ...
  async (req, res) => {
    ...
    const booking: BookingDoc = {
      ...(req.body as Omit<BookingDoc, "userEmail" | "userName" | "status" | "createdAt">),
...
router.patch(
  "/:id/status",
  verifyJWT,
  validate({ params: objectIdParamSchema, body: bookingStatusSchema }),
  async (req, res) => {
    const db = await connectDB();
